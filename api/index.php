...
if ($service === 1) {
    ...
    gee_json_response([
        ...
        'listening_space_type' => (string)($runtime['listening_space_type'] ?? 'renderer'),
        'listening_space_id' => (string)($runtime['listening_space_id'] ?? ''),
        'listening_space_name' => (string)($runtime['listening_space_name'] ?? ($runtime['display_name'] ?? '')),
        'playback_renderer_id' => (string)($runtime['playback_renderer_id'] ?? ($runtime['renderer_id'] ?? '')),
        'active_stream' => (string)($runtime['active_stream'] ?? ''),
        'stream_key' => (string)($runtime['stream_key'] ?? ''),
        'stream_format' => (string)($runtime['stream_format'] ?? ''),
        'image' => $image,
