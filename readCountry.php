...
if(!empty($_POST["keyword"])) {
    ...
    if(!empty($result)) {
        ...
        foreach($result as $country) {
            ...
            if ($term == 1){             
                echo "<li><h4>".$country['title']."<br>".$country['artist']."<br>".$country['album']."</h4><button type='button' id='nxttracksearch".$country['id']."' data-bs-dismiss='modal' class='termgrey' onclick='insertnext(".$country['id'].")'><i class='bi bi-chevron-double-right' style='font-size: 3rem;'></i></button></li>\n";
            }
