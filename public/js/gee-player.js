...
function openTrackSearchPanel() {
    ...
    async function sendCommand(service, successMessage = '') {
        try {
            ...
            // After every player command, let GeeSpaces correct the contact
            // line immediately — ensures room name wins over renderer name
            // without waiting for the 5-second background refresh.
