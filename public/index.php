...
echo "<title id='current-renderer2'>".htmlspecialchars($rendererName, ENT_QUOTES, 'UTF-8')."</title>\n";
...
echo "<div class='pt-3'><h6 id='current-renderer1'>" . htmlspecialchars($rendererName, ENT_QUOTES, 'UTF-8') . "</h6></div>";
...
echo "<table>\n";
    ...
    echo "<tr>\n";
        ...
        echo "<button type='button' class='termwhite mx-auto d-block' data-bs-toggle='modal' data-bs-target='#modalAlbumSearch'><i class='bi bi-vinyl' style='font-size: 7rem;'></i></button>\n";
        echo "</td>\n";
        echo "<td class='border-bottom ps-3' style='width:250px;'>\n";
