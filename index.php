...
echo "html += '<div class=\x22border-bottom align-baseline\x22><h4>' + myObj[x].Track + ' - ' + myObj[x].Title + ' - ' + myObj[x].Artist + '</h4><i class=\x22bi bi-chevron-right\x22 style=\x22font-size: 3rem; color: white;\x22></i><i class=\x22bi bi-chevron-double-right\x22 style=\x22font-size: 3rem; color: white;\x22></i></div>';\n";
echo "}\n";
echo "html += '</div>'\n";    
