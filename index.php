...
echo "<button type='button' class='bg-black' onclick='getmeta(3)'><i class='bi bi-skip-backward' style='font-size: 5rem; color: white;'></i></button>\n";
echo "<button type='button' class='bg-black' onclick='getmeta(3)'><i class='bi bi-skip-start' style='font-size: 5rem; color: white;padding: 0px;'></i></button>\n";
...
echo "<button type='button' class='bg-black' onclick='getmeta(4)'><i class='bi bi-skip-forward' style='font-size: 5rem; color: white;'></i></button>\n";
        ...
        echo "<div class='col-8'>\n";
            echo "<div class='mt-2'>\n";
                echo "<div class='progress bg-dark' style='height: 5px;'>\n";
                    echo "<div id='dynamic1' class='progress-bar bg-white' style='width: %; height: 5px;'></div>\n";
                echo "</div>\n";
            echo "</div>\n";
        echo "</div>\n";
...
echo "<div class='container pt-0 mt-0'>\n";
    echo "<div class='row row-cols-3'>\n";
        ...
        echo "<div class='col-8'>\n";
            echo "<div class='pt-4'>\n";
                echo "<div class='progress bg-dark' style='height: 5px;'>\n";
                    echo "<div id='voldynamic1' class='progress-bar bg-white' style='width: %; height: 5px;'></div>\n";
                echo "</div>\n";
            echo "</div>\n";
        echo "</div>\n";
...
echo "<button type='button' class='btn btn-black' onclick='search()' data-bs-toggle='modal' data-bs-target='#modal2'><i class='bi bi-search' style='font-size: 2.3rem; color: white;'></i></button>\n";
echo "<button type='button' class='bg-black' onclick='volumedown()'><i class='bi bi-volume-down' style='font-size: 2.3rem; color: white;'></i></button>\n";
echo "<button type='button' class='bg-black' onclick='volumeup()'><i class='bi bi-volume-up' style='font-size: 2.3rem; color: white;'></i></button>\n";
echo "<div class='row row-cols-3'>\n";
echo "<div>\n";
...
//*********** Modal 1 id 2 Search Panel ***************

echo "<div class='modal fade' id='modal1' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>\n";
...
echo "<table>\n";
    echo "<tr>\n";
        ...
        echo "<button data-bs-target='#modal3' data-bs-toggle='modal' data-bs-dismiss='modal' type='button' id='termtrack' class='termwhite mx-auto d-block' onclick='searchterm(1)'><i class='bi bi-music-note-beamed' style='font-size: 7rem;'></i></button>\n";
        echo "</td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
        echo "<td class='border-bottom border-end' style='width:250px;'>\n";
...
//*********** Modal 2 id 6 Whole Album ***************

echo "<div class='modal fade' id='modal2' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>\n";
echo "<div class='modal-dialog modal-dialog-scrollable'>\n";
echo "<div class='modal-content bg-black'style='background: black;'>\n";
...
//*********** Modal 3 id 6 Track Search ***************

echo "<div class='modal fade' id='modal3' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>\n";
echo "<div class='modal-dialog modal-dialog-scrollable'>\n";
echo "<div class='modal-content bg-black'style='background: black;'>\n";
