...
echo "<button type=\x22button\x22 class=\x22bg-black\x22 onclick=\x22insertnext('+myObj[x].id+')\x22><i class=\x22bi bi-chevron-double-right\x22 style=\x22font-size: 3rem; color: white;\x22></i></button>";
echo "</div>';\n";
echo "}\n";
echo "html += '</div>'\n";    
...
echo "</div>\n";
echo "<br/>\n";
echo "<button type='button' class='bg-black' onclick='getmeta(1)'><i class='bi bi-arrow-clockwise' style='font-size: 2rem; color: white;'></i></button>\n";
echo "<button type='button' class='bg-black' onclick='getmeta(5)'><i class='bi bi-arrow-repeat' style='font-size: 2rem; color: white;'></i></button>\n";
echo "<button type='button' class='btn btn-black' onclick='wholealbum()' data-bs-toggle='modal' data-bs-target='#staticBackdrop'><i class='bi bi-three-dots' style='font-size: 2rem; color: white;'></i></button>\n";
echo "<button type='button' class='btn btn-black' onclick='wholealbum()' data-bs-toggle='modal' data-bs-target='#staticBackdrop'><i class='bi bi-search' style='font-size: 2rem; color: white;'></i></button>\n";
echo "<button type='button' class='bg-black' onclick='volumedown()'><i class='bi bi-volume-down' style='font-size: 2rem; color: white;'></i></button>\n";
echo "<button type='button' class='bg-black' onclick='volumeup()'><i class='bi bi-volume-up' style='font-size: 2rem; color: white;'></i></button>\n";
echo "<br/>\n";
