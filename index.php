...
echo "<div class='modal-content bg-black'style='background: black;'>\n";
echo "<div class='modal-header'>\n";
echo "<button type='button' class='bg-black' onclick='searchterm(1)'><i id='termtrack' class='bi bi-music-note-beamed termgrey' style='font-size: 2.3rem;'></i></button>\n";
echo "<button type='button' class='bg-black' onclick='searchterm(2)'><i id='termalbum' class='bi bi-vinyl termgrey' style='font-size: 2.3rem;'></i></button>\n";
echo "<button type='button' class='bg-black' onclick='searchterm(3)'><i id='termartist' class='bi bi-mic termgrey' style='font-size: 2.3rem;'></i></button><br><br>\n";
