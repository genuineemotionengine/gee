...
echo "html += '<div class=\x22border-bottom align-baseline\x22><i class=\x22bi bi-chevron-right\x22 style=\x22font-size: 1.5rem; color: white;\x22></i><i class=\x22bi bi-arrow-right-short\x22 style=\x22font-size: 1.5rem; color: white;\x22></i>' + myObj[x].Track + '. ' + myObj[x].Title + '</div>';\n";
echo "}\n";
echo "html += '</div>'\n";    
