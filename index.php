...
echo "<br/>\n";
echo "<button onclick='prevtrack()'><i class='bi bi-arrow-left-short' style='font-size: 6rem; color: white;'></i></button>\n";
echo "<button onclick='playpause()'><i id='playp' class='bi ' style='font-size: 6rem; color: white;'></i></button>\n";
echo "<button onclick='nexttrack()'><i class='bi bi-arrow-right-short' style='font-size: 6rem; color: white;'></i></button><br>\n";
