...
echo "<button type='button' class='bg-black' onclick='getmeta(3)'><i class='bi bi-skip-backward' style='font-size: 4rem; color: white;'></i></button>\n";
...
echo "<button type='button' class='bg-black' onclick='getmeta(4)'><i class='bi bi-skip-forward' style='font-size: 4rem; color: white;'></i></button>\n";
