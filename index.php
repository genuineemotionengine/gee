...
echo "<div class='row row-cols-2'>\n";
    ...
    echo "</div>\n";
    echo "<div class='position-relative col-1'>\n";
    //echo "<div class='position-relative'>\n";
    echo "<div class='position-absolute top-50 start-50 translate-middle'><button type='button' id='termtrack' class='termwhite' onclick='searchterm(1)'><i class='bi bi-music-note-list' style='font-size: 5rem;'></i></button></div>\n";
    //echo "</div>\n";
    echo "</div>\n";
echo "</div>\n";
