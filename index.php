...
echo "html += '<span class=\x22border-bottom\x22><i class=\x22bi bi-arrow-right-short\x22 style=\x22font-size: 2rem; color: white;\x22></i>' + myObj[x].Track + '. ' + myObj[x].Title + '</span>';\n";
echo "}\n";
echo "html += '</div>'\n";    
