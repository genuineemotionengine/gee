...
if ($playpause === pause){
    echo "<div class='col-1 text-start'>".$elapsedpause."</div>\n";
}else{
    echo "<div class='col-1 text-start'><span id='minutes'>00</span>:<span id='seconds'>00</span></div>\n";
}
...
echo "</div>\n";
echo "</div>\n";
echo "<div class='col-1 text-end'>".$duration."</div>\n";
echo "</div>\n";
echo "</div>\n";
