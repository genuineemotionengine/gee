...
echo "<table>\n";
    ...
    echo "<tr>\n";
        echo "<td class='border-bottom border-end' style='width:250px;'>\n";
        echo "<button data-bs-target='#modal4' data-bs-toggle='modal' data-bs-dismiss='modal' type='button' id='termtrack' class='termwhite mx-auto d-block' onclick='searchterm(2)'><i class='bi bi-music-note-beamed' style='font-size: 7rem;'></i></button>\n";
        echo "</td>\n";
        echo "<td class='border-bottom ps-3' style='width:250px;'>\n";
