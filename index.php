...
echo "<button type='button' class='bg-black' onclick='getmeta(2)'><i class='bi bi-pause' style='font-size: 5rem; color: white;'></i><i class='bi bi-slash' style='font-size: 5rem; color: white;'></i><i class='bi bi-chevron-right' style='font-size: 5rem; color: white;'></i></button>\n";
