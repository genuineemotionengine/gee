...
echo "<span class='float-end'><button type='button' class='btn btn-sm' data-bs-dismiss='modal' aria-label='Close'><i class='bi bi-x' style='font-size: 3rem; color: white;'></i></button></span>\n";
echo "</div>\n";
...
echo "<table>\n";
    ...
    echo "<tr>\n";
        ...
        echo "</td>\n";
        echo "<td class='border-bottom' style='width:250px;'>\n";
        echo "<button type='button' id='termtrack' class='termwhite' onclick='searchterm(1)'><i class='bi bi-music-note-list' style='font-size: 7rem;'></i></button>\n";
        echo "</td>\n";
    echo "<tr>\n";
echo "</table>\n";
